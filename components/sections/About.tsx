        ...
        <div className="flex flex-col items-center justify-end w-[600px] space-y-4 mt-10">
          <motion.p
           ...
           initial={{ opacity: 0, x: -100 }}
            ...
            transition={{ duration: 0.5 }}>
            Olá me chamo Gabriel sou um estudante que está começando como desenvolvedor Web sem experiência criando mini projetos pessoais. Gosto de desenvolver aplicações além de estar por dentro das tecnologias e apredendo novas funcionalidades.
          </motion.p>
