    ...
    <section id="skills" className="w-full flex justify-center pt-27 lg:pt-27 lg:pb-40">
      <div className="container ">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="mx-auto w-full grid max-w-5xl items-center gap-6 pb-12 pt-5 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2">
            <div className="flex justify-center">
              <Card className="bg-red-500/90 border-red-500 shadow-red-500 xl:w-full lg:w-full md:w-full w-80">
            ...
            <div className="flex justify-center">
              <Card className="bg-blue-800/90 border-blue-800 shadow-blue-800 xl:w-full lg:w-full md:w-full w-80 ">
                <CardContent className="p-6">
                  <motion.div
            ...
            <div className="flex justify-center">
              <Card className="bg-amber-400/90 border-amber-400 shadow-amber-400 xl:w-full lg:w-full md:w-full w-80 ">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center "
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-blue-600 border-blue-600 shadow-blue-600 xl:w-full lg:w-full md:w-full w-80">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center "
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-blue-400/90 border-blue-400 shadow-blue-400 xl:w-full lg:w-full md:w-full w-80">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-black border-zinc-950 shadow-zinc-950 xl:w-full lg:w-full md:w-full w-80 ">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-indigo-600/90 border-indigo-600 shadow-indigo-600 xl:w-full lg:w-full md:w-full w-80  ">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-emerald-600/90 border-emerald-600 shadow-emerald-600 xl:w-full lg:w-full md:w-full w-80 ">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-cyan-900/90 border-cyan-900 shadow-cyan-900 xl:w-full lg:w-full md:w-full w-80">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
            ...
            <div className="flex justify-center">
              <Card className="bg-green-500/90 border-green-500 shadow-green-500 xl:w-full lg:w-full md:w-full w-80 ">
                <CardContent className="p-6">
                  <motion.div
                    className="flex flex-col items-center space-y-1"
                    initial={{ opacity: 0, x: -100 }}
